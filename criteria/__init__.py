...
from criteria import smoothap,rank,PNP,stablemetric,stable_multisimilarity,circle,proxynca_synthesis,proxy_synthesis
...
def select(loss, opt, to_optim, batchminer=None):
    ...
    losses = {'triplet': triplet,
              ...
              'stable_multisimilarity':stable_multisimilarity,
              'circle':circle,
              'proxynca_synthesis':proxynca_synthesis,
              'proxy_synthesis':proxy_synthesis
              }
