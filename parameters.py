...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--fuse',              default=0.1,      type=float,        help='fuse.')
    
    ##### Loss-specific Settings
    parser.add_argument('--optim',           default='adam',        type=str,   help='Optimization method to use. Currently supported: adam & sgd.')
    parser.add_argument('--loss',            default='contrastive',      type=str,   help='Training criteria: For supported methods, please check criteria/__init__.py')
    parser.add_argument('--m_loss',            default='softmax',      type=str,   help='Training criteria: For supported methods, please check criteria/__init__.py')
    parser.add_argument('--multi_loss',        action='store_true',    help='multi_loss?')
    ...
    parser.add_argument('--test',    action='store_true', help='test first?')
    parser.add_argument('--pool', default='GeM', type=str,help='Pooling method')
...
def loss_specific_parameters(parser):
    ...
    parser.add_argument('--loss_softtriplet_lr',       default=1,    type=float, help='Learning Rate for proxies.')
    ...
    ##relaxation
    parser.add_argument('--relax',             default='reci',  type=str, help='relaxation type.')

    ##normalization size
    parser.add_argument('--alpha',             default=  4,  type=int, help='alpha ')
    ...
    #our methods
    parser.add_argument('--stable',    action='store_true', help='If use stable contrastive loss')
    
    parser.add_argument('--ps_mu',             default= 1.0,  type=float, help='mu')
    parser.add_argument('--ps_alpha',             default=0.4,  type=float, help='alpha')
